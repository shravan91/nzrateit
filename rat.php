...
<form id="form1" method="post" action='rate.php' style="margin:0px; padding:0px;">
	...
	if(isset($_POST['rate']) && isset($_POST['id1']))
	{
		...
		//5 clicks on one place will change the marker from small to medium | medium to big
		...
		// pops up the feedback screen on the web page itself
				echo "<table  align='center' style='border: 5px solid #F52887;' cellspacing=0 cellpading=4><tr><td><font size=4 style='color:#C11B17'>Thank You for rating and being a part of this crowdsourcing project</font></td></tr><tr align='center'><td><font size=3 style='color:#C11B17'>Found a <font style='color:#7D0552'><b>new place</b></font> or a <font style='color:#7D0552'><b>place which doesn't exist</b></font>: <a href=”mailto:rateitappnz@gmail.com?subject=Feedback”>Email us</a>&nbsp;and we'll change it</font></td></tr></table>";
